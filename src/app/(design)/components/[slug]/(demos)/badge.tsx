...
export const badge = {
  ...
  components: {
    include: (
      <Badge variant="include" label="Include">
        Content
      </Badge>
    ),
    exclude: (
      <Badge variant="exclude" label="Exclude">
        Content
      </Badge>
    ),
    primary: (
    ...
    pinkred: (
      <Badge variant="pinkred" label="PinkRed">
        Content
      </Badge>
    ),
    sky: (
      <Badge variant="sky" label="Sky">
        Content
      </Badge>
    ),
    green: (
    ...
    brown: (
      <Badge variant="brown" label="Brown">
        Content
      </Badge>
    ),
    purple: (
